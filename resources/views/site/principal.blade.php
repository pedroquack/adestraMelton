...
@section('conteudo')
    ...
    <section class="comentarios text-center" id="comentarios">
        <h1>Feedbacks</h1>
        <form action="{{route('comentario.store')}}" method="post" class="formComentario d-flex flex-column p-5">
            @csrf
            <div class="elementosForm d-flex p-3 row">
                ...
                <div class="notas d-flex align-items-center justify-content-lg-between justify-content-center col-lg-6 col-12">
                    <div class="rate d-flex align-items-center justify-content-center row">
                        ...
                        <fieldset class="rating col-lg-6 col-12">
                ...
                @endif
                <input class="botaoFormCom" type="submit" value="Enviar">
            </div>
        </form>
        <div class="allComments">
            @foreach ($comentario as $com)
                <div class="com p-3 mt-3">
